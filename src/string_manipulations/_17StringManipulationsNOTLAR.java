...
public class _17StringManipulationsNOTLAR {
     ...
     */
       ...
       /* Scanner input = new Scanner(System.in);
        ...
        System.out.println("tamIsim = " + tamIsim);*/
            ...
            //rakam haricindekileri silin
            String str44 = "$45.99";
            str=str44.replaceAll("\\D","");
            System.out.println("str = " + str);//4599

            //Verilen cumleyi * ile gizleyip, 10.karakterden sonrasini yazdirin
            String cumle22="Her dert Java gibi olsa";

            System.out.println(cumle22.replaceAll("\\w", "*") + cumle22.substring(10));
            //*** **** **** **** ****ava gibi olsa
            ...
            String str34="Learn $Java earn 90000000 money,!... ";
            int sonuc= str34.replaceAll("[0-9]","").
                    replaceAll(" ","").
                    replaceAll("\\p{Punct}","").
                    length();
